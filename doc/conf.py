...
# of the sidebar.
html_logo = "_static/km3astro_logo_small_white.png"
...
man_pages = [
    ("index", "km3astro", u"km3astro Documentation", [u"Tamás Gál and Moritz Lotze"], 1)
]
